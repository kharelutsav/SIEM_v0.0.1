...
impl Mongo {
    ...
    pub async fn create_normalizer (&self, new_normalizer: Normalizer) -> Result<InsertOneResult, Error> {
    ...
    pub async fn get_normalizer (&self, id: &String) -> Result<Normalizer, Error> {
    ...
    pub async fn update_status (&self, id: &String, status: bool) -> Result<UpdateResult, Error> {
        let filter = doc! {
    ...
    pub async fn update_normalizer (&self, updated_normalizer: Normalizer) -> Result<UpdateResult, Error> {
        let filter = doc! {
    ...
    pub async fn get_active_normalizers (&self) -> Result<Vec<Normalizer>, Error>  {
    ...
    pub async fn get_all_normalizers (&self) -> Result<Vec<Normalizer>, Error> {
        let mut cursor = self
            .col
            .find(None, None)
            .await
